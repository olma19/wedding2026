...
export function getColorClasses(scheme: ColorSchemeName = 'pink') {
  const classes = {
    ...
    sage: {
      ...
      bgDarkHover: 'hover:bg-emerald-800',
      text: 'text-emerald-700',
      textDark: 'text-emerald-800',
      textHover: 'hover:text-emerald-800',
      borderLight: 'border-slate-200',
      borderMedium: 'border-emerald-500',
      borderDark: 'border-emerald-700',
      borderHover: 'hover:border-emerald-600',
      ring: 'focus:ring-emerald-700',
      focusBorder: 'focus:border-emerald-700',
      accent: 'accent-emerald-700',
      icon: 'text-emerald-700',
      textMedium: 'text-emerald-600',
      flowerOuter: 'text-emerald-500',
      flowerInner: 'fill-emerald-400',
      flowerCenter: 'fill-emerald-600',
