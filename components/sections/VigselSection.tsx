  ...
  return (
    <section className="relative py-20 px-4 bg-white overflow-hidden scroll-mt-20">
      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        <SectionTitle title="Vigsel" flowerVariant="flower" />
        ...
        <div className="flex flex-row justify-center items-center gap-6 md:gap-8 text-center">
